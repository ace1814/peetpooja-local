            ...
            <div className="space-y-5">
              ...
              <ol className="space-y-4">
                {[
                  ...
                  { n: 3, text: <>Once the project is ready, go to <strong>SQL Editor</strong> and paste + run the migration file below</> },
                ].map(({ n, text }) => (
              ...
              <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                ...
                <p className="text-xs text-gray-400 mt-2">After downloading, paste the entire file contents into Supabase SQL Editor and click Run.</p>
              </div>
